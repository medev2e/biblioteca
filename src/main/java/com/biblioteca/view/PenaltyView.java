...
public class PenaltyView extends javax.swing.JPanel {
    ...
    public double getTxtAmonestacion() {
        return Double.parseDouble(txtAmonestacion.getText());
    }

    public void setTxtAmonestacion(double amonestacion) {
        txtAmonestacion.setText(Double.toString(amonestacion));
    }
